...
from grafanapy.model import timeseriespanelcfg_types_gen, piechartpanelcfg_types_gen
from grafanapy.model.lokidataquery_types_gen import LokiDataQuery
from grafanapy.model.prometheusdataquery_types_gen import PrometheusDataQuery
...
class AnnotationQuery(MyBaseModel):
    ...
    datasource: Union[str, Datasource] = Field(
...
class FieldConfig(MyBaseModel):
    ...
    custom: Optional[
        Union[timeseriespanelcfg_types_gen.GraphFieldConfig, Dict[str, Any]]
    ] = Field(
        {},  # NOTE MODIFIED
...
class Panel(MyBaseModel):
    ...
    targets: Optional[
        List[Union[PrometheusDataQuery, LokiDataQuery, Dict[str, Any]]]
    ] = Field(None)
    ...
    thresholds: Optional[Any] = (
        Field(  # NOTE MODIFIED List->Any, since see double in production
            None,
...
class Dashboard(MyBaseModel):
    ...
    templating: Templating = Field(
        Templating(list=[]), description="TODO docs"
    )  # NOTE MODIFIED
    ...
    def auto_panel_ids(self):
        from grafanapy.utils import dashboard_auto_panel_ids
